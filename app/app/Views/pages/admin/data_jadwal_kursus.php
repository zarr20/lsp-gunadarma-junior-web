...
<div id="jadwal-kursus"  class="container py-5">
    ...
    <a href="/admin/daftar-kursus/tambah" class="btn btn-primary">
+ Tambah 
</a>
</div>
        ...
        <tbody>
            ...
            <?php $i=1; foreach ($data_kursus->getResultArray() as $data) : ?>
                <tr>
                    ...
                    <a href="/admin/daftar-kursus/<?= $data['id'] ?>" class="btn btn-primary">Edit</a>
                    <a href="/admin/daftar-kursus/delete/<?= $data['id'] ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
